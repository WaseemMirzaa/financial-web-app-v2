...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'page.deleteCustomerUnassignAndDelete': 'All employees will be unassigned first. Then all chat history, loan information, and customer data will be permanently deleted from the database (not archived).',
  ...
  ar: {
    ...
    'page.deleteCustomerUnassignAndDelete': 'سيتم إلغاء تعيين جميع الموظفين أولاً. ثم حذف سجل المحادثات ومعلومات القروض وبيانات العميل نهائياً من قاعدة البيانات (بدون أرشفة).',
